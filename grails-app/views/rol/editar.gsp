...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="errors">
                <g:renderErrors bean="${rol}" as="list" />
            </div>
            </g:hasErrors>
            <g:form method="post" >
                <g:hiddenField name="id" value="${rol?.id}" />
                <g:hiddenField name="version" value="${rol?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: rol, field: 'authority', 'errors')}">
                                    <g:textField name="authority" value="${rol?.authority}" />
                                </td>
                            </tr>
