        ...
        <div class="body">
            ...
            <div class="list">
                <table>
                    ...
                    <tbody>
                    <g:each in="${materiaList}" status="i" var="materia">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        
                            <td><g:link action="show" id="${materia.id}">${fieldValue(bean: materia, field: "id")}</g:link></td>
                        
                            <td>${fieldValue(bean: materia, field: "nombre")}</td>
                        
                            <td>${fieldValue(bean: materia, field: "unidadMedida")}</td>
